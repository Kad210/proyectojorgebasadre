                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-start">
                                <div class="flex items-center h-5">
                                    <input id="remember" name="remember" type="checkbox" class="w-4 h-4 border border-gray-600 rounded bg-gray-700 focus:ring-3 focus:ring-red-600 ring-offset-gray-800">
                                </div>
                        ...
                        <p class="text-sm font-light text-gray-400">
                            ¿Aún no tienes una cuenta? <a href="{{ route('register') }}" class="font-medium text-red-500 hover:underline">Regístrate</a>
                        </p>
                    </form>
                </div>
            </div>
